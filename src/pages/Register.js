              ...
              <div className="mt-2">
                <div className="text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <ul className="list-disc list-inside mt-1 space-y-1">
                    <li className={values.password.length >= 8 ? 'text-green-600 dark:text-green-400' : ''}>
                      At least 8 characters
                    </li>
                    <li className={/(?=.*[a-z])/.test(values.password) ? 'text-green-600 dark:text-green-400' : ''}>
                      One lowercase letter
                    </li>
                    <li className={/(?=.*[A-Z])/.test(values.password) ? 'text-green-600 dark:text-green-400' : ''}>
                      One uppercase letter
                    </li>
                    <li className={/(?=.*\d)/.test(values.password) ? 'text-green-600 dark:text-green-400' : ''}>
                      One number
                    </li>
                  </ul>
                </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  autoComplete="new-password"
                  required
                  className={`input-field pr-10 ${errors.confirmPassword && touched.confirmPassword ? 'input-error' : ''}`}
